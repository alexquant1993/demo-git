...
# for an auth given to a certain email
drive_auth(cache = ".secrets", email = "jobs.ibcmadrid@gmail.com")
sheets_auth(token = drive_token())
...
server <- function(input, output, session) {
  ...
  observeEvent(input$add, {
    # You should have or create a googlesheets through google drive
